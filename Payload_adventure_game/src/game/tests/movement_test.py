...
class TestMovement(unittest.TestCase):
    ...
    def test_walk_up(self):
        ...
        self.movement.take_a_step(keys, 5)
    ...
    def test_walk_right(self):
        start_pos = self.player.get_pos()
        print(start_pos)
        keys = {pygame.K_w : False, pygame.K_s : False, pygame.K_a : False, pygame.K_d : True}
        self.movement.take_a_step(keys, 5)
        end_pos = self.player.get_pos()
        print(end_pos)
        self.assertEqual(start_pos[1] == end_pos[1], True)
    ...
    def test_walk_right_down(self):
        start_pos = self.player.get_pos()
        print(start_pos)
        keys = {pygame.K_w : False, pygame.K_s : True, pygame.K_a : False, pygame.K_d : True}
        self.movement.take_a_step(keys, 5)
        end_pos = self.player.get_pos()
        print(end_pos)
        self.assertEqual(start_pos[1]-end_pos[1] == -5, True)
    ...
    def test_walk_left_up(self):
        start_pos = self.player.get_pos()
        print(start_pos)
        keys = {pygame.K_w : True, pygame.K_s : False, pygame.K_a : True, pygame.K_d : False}
        self.movement.take_a_step(keys, 5)
        end_pos = self.player.get_pos()
        print(end_pos)
        self.assertEqual(start_pos[1]- end_pos[1] == 5, True)
    ...
    def test_walking(self):
        ...
        self.assertEqual(self.movement.movement_speed(keys) == 5, True)


    def test_crawling(self):
        keys = {pygame.K_LCTRL : True, pygame.K_LSHIFT : False}
        self.assertEqual(self.movement.movement_speed(keys) == 3, True)

    def test_running(self):
        keys = {pygame.K_LCTRL : False, pygame.K_LSHIFT : True}
        self.assertEqual(self.movement.movement_speed(keys) == 7, True)
    ...
    def test_dash_with_SPACE(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : False, pygame.K_s : False, pygame.K_a : False, pygame.K_d : False}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (0,-10,20,20), True)

    def test_dash_with_SPACE_w(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : True, pygame.K_s : False, pygame.K_a : False, pygame.K_d : False}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (0,-10,20,20), True)

    def test_dash_with_SPACE_s(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : False, pygame.K_s : True, pygame.K_a : False, pygame.K_d : False}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (0,10,20,20), True)

    def test_dash_with_SPACE_a(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : False, pygame.K_s : False, pygame.K_a : True, pygame.K_d : False}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (-10,0,20,20), True)

    def test_dash_with_SPACE_d(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : False, pygame.K_s : False, pygame.K_a : False, pygame.K_d : True}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (10,0,20,20), True)

    def test_dash_with_SPACE_w_a(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : True, pygame.K_s : False, pygame.K_a : True, pygame.K_d : False}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (-10,-10,20,20), True)

    def test_dash_with_SPACE_s_d(self):
        keys = {pygame.K_SPACE : True, pygame.K_w : False, pygame.K_s : True, pygame.K_a : False, pygame.K_d : True}
        self.movement.dash(keys)
        print(self.player.rect)
        self.assertEqual(self.player.rect == (10,10,20,20), True)
